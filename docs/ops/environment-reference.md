...
| `OPERATIONAL_ENDPOINTS_TOKEN`       | Required in production                 | blank                                 | Bearer or `X-Operational-Token` credential for full `/health`, `/metrics`, `/docs`, and operational WebSocket handshakes; must be at least 32 characters |
