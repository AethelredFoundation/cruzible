...
CW20 staking token `UpdateMinter` transaction that hands mint authority to the
vault and the model registry `UpdateConfig` transaction that authorizes the
deployed AI job manager.
