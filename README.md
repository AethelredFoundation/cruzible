...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Frontend          | Next.js 15 app under `src/` with machine-checked public route inventory for `/`, `/vault`, `/validators`, `/jobs`, `/models`, `/seals`, `/stablecoins`, `/reconciliation`, `/devtools`, `/governance`, and `/api/health`; vault staking flows include tested risk, proof, and withdrawal-liquidity disclosures |
